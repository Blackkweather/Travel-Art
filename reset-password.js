 ...
 * 
 * Or use the script in backend/reset-password.js directly
 */

console.log('⚠️  Please run this script from the backend directory:');
console.log('   cd backend');
console.log('   node reset-password.js <email> <new-password>');
console.log('');
console.log('Or use: node backend/reset-password.js <email> <new-password>');
process.exit(1);
