  ...
  return (
    <div className="min-h-screen bg-[var(--surface)]">
      ...
      <main className="container mx-auto px-6 pt-28 pb-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-content mb-6">À propos de Travel Art</h1>
        <p className="text-content-secondary mb-10">Réunir les artistes et les hôtels d’exception, partout dans le monde.</p>

        <section className="space-y-6 text-content-secondary">
          <h2 className="text-2xl font-serif font-semibold text-content">Notre mission</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Ce que nous faisons</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Pour les artistes</h2>
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Pour les hôtels</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Nos valeurs</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Nous écrire</h2>
          <p>
