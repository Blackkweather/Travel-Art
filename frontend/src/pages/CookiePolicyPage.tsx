  ...
  return (
    <div className="min-h-screen bg-[#08101D]">
      ...
      <main className="container mx-auto px-6 pt-28 pb-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6">Cookie Policy</h1>
        <p className="text-white/60 mb-10">This page explains how we use cookies and similar technologies.</p>

        <section className="space-y-6 text-white/75">
          <h2 className="text-2xl font-serif font-semibold text-white">What Are Cookies?</h2>
          <p>
            Cookies are small text files stored on your device to help websites work and to provide
            analytics and personalization.
          </p>

          <h2 className="text-2xl font-serif font-semibold text-white">How We Use Cookies</h2>
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">Managing Cookies</h2>
          <p>
