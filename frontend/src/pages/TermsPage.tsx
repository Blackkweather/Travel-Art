  ...
  return (
    <div className="min-h-screen bg-[#08101D]">
      ...
      <main className="container mx-auto px-6 pt-28 pb-20 max-w-4xl">
        ...
        <p className="text-white/60 mb-10">Please read these terms carefully before using Travel Art.</p>

        <section className="space-y-6 text-white/75">
          <h2 className="text-2xl font-serif font-semibold text-white">1. Agreement</h2>
          <p>
            By accessing or using the site, you agree to be bound by these Terms. If you do not agree,
            do not use the platform.
          </p>

          <h2 className="text-2xl font-serif font-semibold text-white">2. Accounts</h2>
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">3. Bookings & Payments</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">4. Acceptable Use</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>No unlawful, harmful, or abusive activities.</li>
            <li>Respect intellectual property and privacy of others.</li>
          </ul>

          <h2 className="text-2xl font-serif font-semibold text-white">5. Liability</h2>
          <p>
            The service is provided “as is” without warranties. To the maximum extent permitted by law,
            we are not liable for indirect, incidental, or consequential damages.
          </p>

          <h2 className="text-2xl font-serif font-semibold text-white">6. Changes</h2>
          <p>
