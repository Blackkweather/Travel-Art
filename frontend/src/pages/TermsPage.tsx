  ...
  return (
    <div className="min-h-screen bg-[#08101D]">
      ...
      <main className="container mx-auto px-6 pt-28 pb-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6">Conditions générales d’utilisation</h1>
        <p className="text-white/60 mb-10">Merci de lire attentivement ces conditions avant d’utiliser Travel Art.</p>

        <section className="space-y-6 text-white/75">
          <h2 className="text-2xl font-serif font-semibold text-white">1. Acceptation</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">2. Comptes</h2>
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">3. Réservations et paiements</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">4. Usage acceptable</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">5. Responsabilité</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">6. Modifications</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-semibold text-white">7. Contact</h2>
          <p>
