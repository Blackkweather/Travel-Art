...
const PricingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#08101D]">
            ...
            <div key={plan.name} className="relative">
              {plan.popular && (
                <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 z-20">
                  <div className="bg-gradient-to-r from-gold to-gold/90 text-white px-6 py-2.5 rounded-control shadow-2xl border-2 border-white flex items-center gap-2">
              ...
              >
                ...
                <button className={`w-full py-3 rounded-card font-medium transition-colors ${
                  plan.popular 
                    ? 'bg-[var(--surface-raised)] text-white border-2 border-gold hover:bg-[#0C1526]' 
        ...
        <div className="max-w-4xl mx-auto mt-12">
          <div className="card-luxury bg-gold/10 border-2 border-gold">
            <div className="flex items-start space-x-4">
              <div className="bg-gold/20 p-3 rounded-control">
      ...
      <div className="bg-[#0C1526] py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="mt-6 inline-flex items-center space-x-2 bg-gold/20 px-6 py-3 rounded-card">
              ...
              <div key={plan.name} className="relative">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="mb-4">
                    ...
                    {plan.bonusCredits && (
                      <div className="mt-2">
                        <span className="bg-gold/20 text-gold px-3 py-1 rounded-control text-sm font-bold">
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      <Check className="w-5 h-5 text-gold mr-3 mt-0.5 flex-shrink-0" />
                      <span className={`${feature.includes('FREE') ? 'text-gold font-semibold' : 'text-white/60'}`}>
                        {feature}
                      </span>
                    </li>
                  ))}
      ...
      <div className="bg-[var(--surface-raised)] py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-serif font-bold text-white mb-6 gold-underline">
              Artist Ranking System
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/register" className="bg-transparent text-white border-2 border-white px-8 py-4 rounded-card font-semibold text-lg hover:bg-[var(--surface-raised)]/10">
                Join as Artist
              </a>
              <a href="/register" className="bg-transparent text-white border-2 border-white px-8 py-4 rounded-card font-semibold text-lg hover:bg-[var(--surface-raised)]/10">
                Join as Hotel
