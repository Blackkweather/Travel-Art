  ...
  return (
    <div className="min-h-screen bg-[var(--surface)]">
      ...
      <main className="container mx-auto px-6 pt-28 pb-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-content mb-6">Politique de confidentialité</h1>
        <p className="text-content-secondary mb-10">Last updated: {new Date().getFullYear()}</p>
        ...
        <section className="space-y-6 text-content-secondary">
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Les données que nous collectons</h2>
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">L’usage que nous en faisons</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Partage des données</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Vos choix</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-serif font-semibold text-content mt-8">Contact</h2>
          <p>
