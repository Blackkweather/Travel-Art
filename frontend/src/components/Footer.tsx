      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/how-it-works" className="text-gray-300 hover:text-gold transition-colors">
                  How it Works
                </Link>
              </li>
              <li>
                <Link to="/partners" className="text-gray-300 hover:text-gold transition-colors">
                  Partners
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/top-artists" className="text-gray-300 hover:text-gold transition-colors">
                  Top Artists
                </Link>
              </li>
              <li>
                <Link to="/top-hotels" className="text-gray-300 hover:text-gold transition-colors">
                  Top Hotels
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">hello@travelart.com</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/cookies" className="text-gray-400 hover:text-gold transition-colors text-sm">
              Cookie Policy
            </Link>
          </div>
        </div>
