...
CREATE TABLE "trips" (
    ...
    CONSTRAINT "trips_artistId_fkey" FOREIGN KEY ("artistId") REFERENCES "artists" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "trips_hotelId_fkey" FOREIGN KEY ("hotelId") REFERENCES "hotels" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
